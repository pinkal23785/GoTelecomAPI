...
namespace GO.Web.ShareHolders.Data
{
    ...
    {
        Task SendCustomerOTP(string MobileNumber, string Lang);
    ...
    public class OTPService : IOTPService
    {
        ...
        public async Task SendCustomerOTP(string MobileNumber, string Lang = "en")
        {
        ...
        {
            return await _dataservice.VerifyOTP(details);
        }
