...
namespace Go.Web.Invoices
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<BRMDBContext>(options => options.UseOracle(Configuration.GetConnectionString("BRMDBConnectionString"),
                         opt =>
                         {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Bills}/{action=Invoice}/{id?}");
            });
        }
    }
}
