...
namespace FTTH.Collection.Services2
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual int EQUIPMENT_SIM_DETAILS(string p_SERIAL_ID, string v_TYPE, ObjectParameter v_IMSI, ObjectParameter v_MSISDN, ObjectParameter v_ICCID, ObjectParameter v_MACID, ObjectParameter v_CPE_MODEL, ObjectParameter v_STATUS)
        {
